<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Pages_Account_ChangePassword" %>
        ...
        <tr>
            ...
            <asp:TextBox ID="txtOldPassword" runat="server" TextMode="Password" Width="250px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtOldPassword" ErrorMessage="*" ForeColor="#34000D"></asp:RequiredFieldValidator>
                <br />
             </td>
        </tr>
        <tr>
